# [DEPRECATED] Linkedin Pages Source dbt Package

> _This package has been archived and is no longer maintained. Use [`dbt_linkedin_pages`](https://github.com/fivetran/dbt_linkedin_pages) instead, which now contains all models previously found here._
